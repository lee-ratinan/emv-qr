...
class EmvMerchant {
    ...
    const PAYLOAD_FORMAT_INDICATOR_ONE_VALUE = '01';
    const PAYLOAD_FORMAT_INDICATOR_ONE_MEANING = 'STATIC VALUE 01';
    ...
    const POINT_OF_INITIATION_STATIC_VALUE = '11';
    const POINT_OF_INITIATION_STATIC_MEANING = 'STATIC';
    const POINT_OF_INITIATION_DYNAMIC_VALUE = '12';
    const POINT_OF_INITIATION_DYNAMIC_MEANING = 'DYNAMIC';
    ...
    const MERCHANT_CATEGORY_CODE_GENERIC_VALUE = '0000';
    const MERCHANT_CATEGORY_CODE_GENERIC_MEANING = 'Generic';
...
//
    ...
    const TRANSACTION_CURRENCY_SGD_VALUE = '702';
    const TRANSACTION_CURRENCY_SGD_MEANING = 'SGD';
    const TRANSACTION_CURRENCY_THB_VALUE = '764';
    const TRANSACTION_CURRENCY_THB_MEANING = 'THB';
    const TRANSACTION_CURRENCY_IDR_VALUE = '360';
    const TRANSACTION_CURRENCY_IDR_MEANING = 'IDR';
    /**
     * @var string[] ISO4217
     */
    protected $currency_codes = [
        self::TRANSACTION_CURRENCY_IDR_VALUE => self::TRANSACTION_CURRENCY_IDR_MEANING,
        self::TRANSACTION_CURRENCY_SGD_VALUE => self::TRANSACTION_CURRENCY_SGD_MEANING,
        self::TRANSACTION_CURRENCY_THB_VALUE => self::TRANSACTION_CURRENCY_THB_MEANING
    ];
    ...
    const VALUE_OF_FEE_FIXED_ID = '56';
    const VALUE_OF_FEE_FIXED_KEY = 'VALUE_OF_FEE_FIXED';
    const VALUE_OF_FEE_PERCENTAGE_ID = '57';
    const VALUE_OF_FEE_PERCENTAGE_KEY = 'VALUE_OF_FEE_PERCENTAGE';
    const TIP_OR_CONVENIENCE_FEE_TIP_VALUE = '01';
    const TIP_OR_CONVENIENCE_FEE_TIP_MEANING = 'TIP';
    const TIP_OR_CONVENIENCE_FEE_FIXED_VALUE = '02';
    const TIP_OR_CONVENIENCE_FEE_FIXED_MEANING = 'CONVENIENCE_FEE_FIXED';
    const TIP_OR_CONVENIENCE_FEE_PERCENTAGE_VALUE = '03';
    const TIP_OR_CONVENIENCE_FEE_PERCENTAGE_MEANING = 'CONVENIENCE_FEE_PERCENTAGE';
    protected $tip_or_convenience_fee_indicators = [
        self::TIP_OR_CONVENIENCE_FEE_TIP_VALUE        => self::TIP_OR_CONVENIENCE_FEE_TIP_MEANING,
        self::TIP_OR_CONVENIENCE_FEE_FIXED_VALUE      => self::TIP_OR_CONVENIENCE_FEE_FIXED_MEANING,
        self::TIP_OR_CONVENIENCE_FEE_PERCENTAGE_VALUE => self::TIP_OR_CONVENIENCE_FEE_PERCENTAGE_MEANING
    ];
    ...
    const COUNTRY_CODE_ID_VALUE = 'ID';
    const COUNTRY_CODE_ID_MEANING = 'INDONESIA';
    const COUNTRY_CODE_SG_VALUE = 'SG';
    const COUNTRY_CODE_SG_MEANING = 'SINGAPORE';
    const COUNTRY_CODE_TH_VALUE = 'TH';
    const COUNTRY_CODE_TH_MEANING = 'THAILAND';
    /**
     * @var string[] ISO3166
     */
    protected $country_codes = [
        self::COUNTRY_CODE_ID_VALUE,
        self::COUNTRY_CODE_SG_VALUE,
        self::COUNTRY_CODE_TH_VALUE
    ];
    /**
     * @var string[] COUNTRY NAMES
     */
    protected $country_names = [
        self::COUNTRY_CODE_ID_VALUE => self::COUNTRY_CODE_ID_MEANING,
        self::COUNTRY_CODE_SG_VALUE => self::COUNTRY_CODE_SG_MEANING,
        self::COUNTRY_CODE_TH_VALUE => self::COUNTRY_CODE_TH_MEANING
    ];
     ...
     * POSTAL CODE (61)
     */
    const MERCHANT_POSTAL_CODE_ID = '61';
    const MERCHANT_POSTAL_CODE_KEY = 'MERCHANT_POSTAL_CODE';

    /**
     * ADDITIONAL DATA (62)
     */
    const ADDITIONAL_DATA_FIELDS_ID = '62';
    const ADDITIONAL_DATA_FIELDS_KEY = 'ADDITIONAL_DATA_FIELDS';
    const BILL_NUMBER_ID = '01';
    const BILL_NUMBER_KEY = 'BILL_NUMBER';
    const MOBILE_NUMBER_ID = '02';
    const MOBILE_NUMBER_KEY = 'MOBILE_NUMBER';
    const STORE_LABEL_ID = '03';
    const STORE_LABEL_KEY = 'STORE_LABEL';
    const LOYALTY_NUMBER_ID = '04';
    const LOYALTY_NUMBER_KEY = 'STORE_LABEL';
    const REFERENCE_LABEL_ID = '05';
    const REFERENCE_LABEL_KEY = 'REFERENCE_LABEL';
    const CUSTOMER_LABEL_ID = '06';
    const CUSTOMER_LABEL_KEY = 'CUSTOMER_LABEL';
    const TERMINAL_LABEL_ID = '07';
    const TERMINAL_LABEL_KEY = 'TERMINAL_LABEL';
    const PURPOSE_OF_TRANSACTION_ID = '08';
    const PURPOSE_OF_TRANSACTION_KEY = 'PURPOSE_OF_TRANSACTION';
    const ADDITIONAL_CUSTOMER_DATA_REQUEST_ID = '09';
    const ADDITIONAL_CUSTOMER_DATA_REQUEST_KEY = 'ADDITIONAL_CUSTOMER_DATA_REQUEST';
    const MERCHANT_TAX_ID_ID = '10';
    const MERCHANT_TAX_ID_KEY = 'MERCHANT_TAX_ID';
    const MERCHANT_CHANNEL_ID = '11';
    const MERCHANT_CHANNEL_KEY = 'MERCHANT_CHANNEL';
    // ADDITIONAL_CUSTOMER_DATA_REQUEST VALUES
    const ADDITIONAL_CUSTOMER_DATA_REQUEST_MOBILE_VALUE = 'M';
    const ADDITIONAL_CUSTOMER_DATA_REQUEST_MOBILE_MEANING = 'MOBILE';
    const ADDITIONAL_CUSTOMER_DATA_REQUEST_ADDRESS_VALUE = 'A';
    const ADDITIONAL_CUSTOMER_DATA_REQUEST_ADDRESS_MEANING = 'ADDRESS';
    const ADDITIONAL_CUSTOMER_DATA_REQUEST_EMAIL_VALUE = 'E';
    const ADDITIONAL_CUSTOMER_DATA_REQUEST_EMAIL_MEANING = 'EMAIL';
    // MERCHANT_CHANNEL VALUES
    const MERCHANT_CHANNEL_CHAR_MEDIA_KEY = 'MEDIA';
    const MERCHANT_CHANNEL_CHAR_LOCATION_KEY = 'LOCATION';
    const MERCHANT_CHANNEL_CHAR_PRESENCE_KEY = 'PRESENCE';
     ...
     */
    const MERCHANT_INFORMATION_LANGUAGE_TEMPLATE_ID = '64';
    const MERCHANT_INFORMATION_LANGUAGE_TEMPLATE_KEY = 'MERCHANT_INFORMATION_LANGUAGE_TEMPLATE';
//
//    /**
//     * Integers
//     */

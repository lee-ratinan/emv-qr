...
class EmvMerchantCategoryCode {
    ...
    /**
     * EmvMerchantCategoryCode constructor.
    ...
    /**
     * Generate the string for Merchant Category Code
     * The string must be 4-digit code as found in ISO18245
     * The default value is always '0000' as set in DEFAULT_CODE
     * @param string $code
     * @return string
     */
    public function generate($code = self::DEFAULT_CODE)
    {
        if ( ! isset($this->merchant_category_codes[$code]))
        {
